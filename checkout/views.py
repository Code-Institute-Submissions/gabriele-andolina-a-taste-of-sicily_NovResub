...
def checkout(request):
    ...
    if request.method == "POST":
        ...
        form_data = {
            ...
            'region_or_county': request.POST['region_or_county'],
        ...
        if request.user.is_authenticated:
            try:
                ...
                order_form = OrderForm(initial={
                    ...
                    'region_or_county': profile.default_region_or_county,
    ...
    if not stripe_public_key:
        messages.warning(request, 'Stripe public key is missing. \
            Don\'t forget to set it in your environment!')
    ...
    if request.user.is_authenticated:
        ...
        if save_info:
            profile_data = {
                ...
                'default_region_or_county': order.region_or_county,
